...
namespace GitHub.Runner.Common
{
    ...
    public abstract class RunnerService
    {
        ...
        protected async Task<VssConnection> EstablishVssConnection(Uri serverUrl, VssCredentials credentials, TimeSpan timeout, bool rawConnection = false)
        {
            ...
            {
                Trace.Info($"EstablishVssConnection:CreateConnection");
                var connection = VssUtil.CreateConnection(serverUrl, credentials, timeout: timeout, rawConnection: rawConnection);
                try
                {
                    Trace.Info($"EstablishVssConnection:ConnectAsync");
